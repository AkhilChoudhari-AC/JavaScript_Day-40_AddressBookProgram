...
function selectFunction(select){
    switch(select){
        case "contactDetails":
                 ...
                 */
                contactDetails("Akhil","Choudhari","DrishtiCity","Bhopal","MadhyaPradesh","462 042","akhil.ac@gmail.com","91 9998887771");
                contactDetails("Ashu","Pant","OmColony","AshokNagar","MadhyaPradesh","473 331","ashupant@gmail.com","91 9998887772");
        ...
        case "editContact":
                ...
                */
                editContact("Akhil","city","AshokNagar");
                console.log(addressBook);
                break;
        case "deleteContact":
                /*
        ...
        case "searchByCity_State":
                ...
                */
                searchByCity_State("state","MadhyaPradesh");
                break;
